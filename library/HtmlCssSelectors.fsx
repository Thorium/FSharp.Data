...
<html lang="en">
  ...
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=dojQZ4HVKL670PEPl52j8A8" http-equiv="refresh" />
      <div style="display:block">
        Please click <a href="/httpservice/retry/enablejs?sei=dojQZ4HVKL670PEPl52j8A8">here</a> if you are not redirected within a few seconds.
      </div>
   ...*)
(**
