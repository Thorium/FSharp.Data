...
val stats: (string * decimal) array =
  [|("6.4", 275406M); ("6.3", 307364M); ("6.2", 134917M); ("6.1", 3083M);
    ("6.0", 17719M); ("5.0", 446183M); ("4.2", 858207M); ("4.1", 194799M);
    ("4.0", 117549M); ("3.3", 1230789M); ("3.2", 61209M); ("3.1", 261198M);
    ("3.0", 633281M); ("2.4", 483894M); ("2.3", 631927M); ("2.2", 371666M);
    ("2.1", 45671M); ("2.0", 165780M); ("1.1", 124516M); ("1.0", 77159M)|]*)
(**
