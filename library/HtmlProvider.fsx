...
val stats: (string * decimal) array =
  [|("6.5", 0M); ("6.4", 387823M); ("6.3", 335428M); ("6.2", 140954M);
    ("6.1", 3093M); ("6.0", 17938M); ("5.0", 457707M); ("4.2", 884557M);
    ("4.1", 198534M); ("4.0", 120601M); ("3.3", 1250991M); ("3.2", 63821M);
    ("3.1", 262464M); ("3.0", 642401M); ("2.4", 486105M); ("2.3", 639085M);
    ("2.2", 373696M); ("2.1", 45970M); ("2.0", 167752M); ("1.1", 125814M);
    ("1.0", 78183M)|]*)
(**
