...
<html lang="en">
  ...
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=eIjQZ7GiHc6q0PEPoo_RkAE" http-equiv="refresh" />
      <div style="display:block">
        Please click <a href="/httpservice/retry/enablejs?sei=eIjQZ7GiHc6q0PEPoo_RkAE">here</a> if you are not redirected within a few seconds.
      </div>
   ...*)
(**
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=eIjQZ7GiHc6q0PEPoo_RkAE");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=fd720482c30bdadb&ie=UTF-8&emsg="+[34 chars]);
