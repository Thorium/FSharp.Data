...
<html lang="en">
  ...
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=0AOJZ4zWOqjU5NoP1teG2AQ" http-equiv="refresh" />
      <div style="display:block">
        Please click <a href="/httpservice/retry/enablejs?sei=0AOJZ4zWOqjU5NoP1teG2AQ">here</a> if you are not redirected within a few seconds.
      </div>
   ...*)
(**
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=0AOJZ4zWOqjU5NoP1teG2AQ");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=eb1dff64004fdd40&ie=UTF-8&emsg="+[34 chars]);
